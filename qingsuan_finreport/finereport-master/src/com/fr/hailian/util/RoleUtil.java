...
//				}
	...
	public static List<RoleModel> getUserRoles(String userId,String userName,String roleName,boolean isSuperAdmin){
       ...
       try {
    	   con = C3P0Utils.getInstance().getConnection();
           String sql = "select distinct m.id, rolename, description, sortindex, issync from fr_t_customrole m left join fr_t_customrole_user t ";
	...
	public static List<RoleMenuModel> getMenuByRoleName(String  userId,String roleName,boolean isSuperAdmin){
        ...
        con = C3P0Utils.getInstance().getConnection();
        String sql = "select distinct p.name as pname,a.type||b.id as id,'0'||b.parent as pid,b.name,b.url as reportletpath,b.description, b.sortindex,p.sortindex AS pindex  ";
